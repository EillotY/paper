...
def intersec(first, second):
    overlap = False
    overlap = overlap or (
            first[0] <= second[0] and second[0] <= first[2] and first[1] <= second[1] and second[1] <= first[3])
    overlap = overlap or (
            first[0] <= second[2] and second[2] <= first[2] and first[1] <= second[1] and second[1] <= first[3])
    overlap = overlap or (
            first[0] <= second[0] and second[0] <= first[2] and first[1] <= second[3] and second[3] <= first[3])
    overlap = overlap or (
            first[0] <= second[2] and second[2] <= first[2] and first[1] <= second[3] and second[3] <= first[3])
    return overlap
